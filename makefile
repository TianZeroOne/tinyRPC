...
# will install lib to /usr/local/lib/libtinyrpc.a
PATH_INSTALL_LIB_ROOT = /usr/local/lib

# will install all header file to /usr/local/include/tinyrpc
...
# PATH_TINYXML = /usr/local/include/tinyxml
...
# MYSQL_LIB = /usr/local/lib/libmysqlclient.a
